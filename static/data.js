window.ENGLISH_EXAM = {
  ...
  sections: [
    ...
    },
    {
      ...
      passage: [
        "Akira: Did you know Slovakia makes a huge number of cars? Mika: Slovakia? I only know it’s in Europe. Is it big? Akira: Not really. It’s a small country in Central Europe, with about 5.4 million people. But it produces close to one million cars every year.",
        ...
        "Mika: Why does Slovakia produce so many cars? Akira: Several major global car companies have large plants in Slovakia—Volkswagen, Kia, Stellantis, and Jaguar Land Rover. They choose Slovakia for a few reasons. First, its location. Slovakia is in the center of Europe, so it’s easier to send cars and parts to nearby countries. Second, its skilled workers. Many people there are good at manufacturing and technical work.",
        ...
        "Mika: Does the government do anything to support this? Akira: Yes. That’s another reason. The Slovak government has offered incentives to attract investment, like support for building factories or training workers. That helped create a strong ‘car ecosystem,’ not just the factories themselves.",
        "Mika: What do you mean by ‘ecosystem’? Akira: I mean related businesses. If car companies come, parts makers and logistics companies also come. More companies need more services—transportation, maintenance, and even food businesses around the factories. Mika: つまり、自動車産業は、間接的にもたくさんの仕事を生み出しているのね。 Akira: Exactly. And salaries in car manufacturing are often higher than the national average, so for some people, it improves their living standards.",
        "Mika: That sounds like a success story. Akira: Yeah, it does. But there are challenges too. The global car industry is changing fast. Electric cars are becoming more popular, and new technologies like automation and self-driving systems are developing quickly.",
        ...
        "Akira: That’s a good way to put it. Slovakia can be proud of being the world’s top car producer per capita, but to keep that position, it has to keep learning and updating its industry. Mika: Interesting. It shows that size isn’t everything—strategy, skills, and good planning can make a country stand out."
      ],
      questions: [
        ...
        { id: "III-A-2", prompt: "本文における plants の意味に最も近いものを選べ。", options: ["cars", "factories", "gardens", "trees"], answer: 1, explanation: "自動車会社が持つ large plants は『大規模な工場』です。" },
    ...
    },
    {
      ...
      questions: [
        { id: "III-B-1", type: "fields", prompt: "So, the car industry has [ c　　 ] many jobs [ i　　 ] as well.", fields: [{label:"c...",answers:["created"]},{label:"i...",answers:["indirectly"]}], explanation: "『自動車産業は間接的にも多くの仕事を生み出した』なので created / indirectly。" },
